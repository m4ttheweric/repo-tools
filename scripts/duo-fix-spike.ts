 ...
 *
 * Hardcoded for assured-dev (project 15627023) for this spike. Override with
...
const FULL_PATH   = process.env.DUO_FIX_SPIKE_FULL_PATH ?? "assured/assured-dev";
...
async function probe(mrIid: string) {
  ...
  if (!ready) {
    ...
    console.log("  https://gitlab.com/groups/assured/-/automate/ai_agents/catalog");
  }
}
