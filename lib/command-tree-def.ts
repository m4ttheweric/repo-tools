...
export const TREE: Record<string, CommandNode> = {
  ...
  chat: {
    ...
    args: [
      ...
      { name: "Quiet", flag: "--quiet", type: "boolean", default: false, hint: "For post: put the message on the room record without waking anyone; it stays unread and catches up in a later delivery" },
