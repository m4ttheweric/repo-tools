...
export const TREE: Record<string, CommandNode> = {
  ...
  chat: {
    ...
    args: [
      ...
      { name: "Room", type: "text", placeholder: "build", hint: "Room name (join/leave/post/read/who/mark); the target handle for dm; omit on read/rooms/who to span everything" },
      { name: "Text", type: "text", placeholder: "@handle message", hint: "The message body (every word after the room/handle) — post, dm, away" },
      ...
      { name: "JSON", flag: "--json", type: "boolean", default: false, hint: "Emit machine-readable JSON instead of the plain rendering (buddies/who/rooms/pulse/dm/away/back/sign-in/sign-out)" },
    ],
  },
